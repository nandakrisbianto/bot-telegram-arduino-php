...
$TOKEN = "1019308487:AAHIXaYIOXOPJTGZVlZAFJtbX-cssm9Xy-8";
$usernamebot= "@NandakrisBot"; // sesuaikan besar kecilnya, bermanfaat nanti jika bot dimasukkan grup.
...
case '/on':
case '/on'.$usernamebot : //dipakai jika di grup yang haru ditambahkan @usernamebot
$hasil = "Hallo $namauser, Lampu 1 sudah hidup";
exec("ECHO 1 > COM3");
break;

case '/off':
case '/off'.$usernamebot : //dipakai jika di grup yang haru ditambahkan @usernamebot
$hasil = "Hallo $namauser, Lampu 1 sudah padam";
exec("ECHO 2 > COM3");
break;
...
default:
$hasil = "
Halo $namauser selamat datang di bot Nanda Krisbianto jika ingin silahkan gunakan /time untuk cek waktu hari ini
